...
Serve the repository root with any static server and open the pages under `/sponsor_pitches/`. Both sources reuse the approved ScienceClaw identity assets from `swarm/assets/logos/`. Shared event facts, partnership tiers, benefits, and sponsor guardrails live in `assets/content.js`.
...
- `exports/scienceclaw-founding-partnership-deck.pdf`
- `exports/scienceclaw-sponsorship-opportunity.pdf`
